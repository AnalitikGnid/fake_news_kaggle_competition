...
best_model.save(output_dir_best / 'best_lstm_st.h5')

from helper_functions import *

# Evaluate the best model
fpr, tpr, thresholds, auc_score, cm = evaluate_classifier(y_test, y_pred_probs.flatten(), threshold=0.5, plot=True, model_name="LSTM_ST")
# Plot efficiencies
